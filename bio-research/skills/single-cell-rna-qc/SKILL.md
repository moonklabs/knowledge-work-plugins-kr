...
description: MAD 기반 필터링과 종합 시각화를 포함한 scverse 모범 사례로 single-cell RNA-seq 데이터(.h5ad 또는 .h5 파일)에 품질 통제를 수행합니다. QC 분석, 저품질 세포 필터링, 데이터 품질 평가, single-cell 분석을 위한 scverse/scanpy 모범 사례 적용 요청에 사용합니다.
---
