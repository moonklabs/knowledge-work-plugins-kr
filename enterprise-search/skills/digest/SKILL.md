---
name: digest
description: 연결된 소스 전반의 활동을 일일 또는 주간 다이제스트로 생성합니다. 자리를 비운 뒤 따라잡거나, 하루를 시작하며 멘션과 액션 아이템 요약이 필요하거나, 프로젝트별로 묶인 한 주의 의사결정과 문서 업데이트를 검토할 때 사용합니다.
argument-hint: "[--daily | --weekly | --since <date> 중 하나]"
---
