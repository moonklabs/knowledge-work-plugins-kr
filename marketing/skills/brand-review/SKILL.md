---
name: brand-review
description: 브랜드 보이스, 스타일 가이드, 메시징 축에 맞춰 콘텐츠를 검토하고 이탈을 심각도별로 표시하며 구체적인 전/후 수정안을 제공합니다. 초안 출고 전 check, 보이스 일관성과 용어 감사, 근거 없는 주장, 누락된 disclaimer, 기타 legal 표시 스크리닝에 사용합니다.
argument-hint: "<검토할 content>"
---
