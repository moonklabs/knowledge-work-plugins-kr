...
description: 테스트 전략과 테스트 계획을 설계합니다. "how should we test", "test strategy for", "write tests for", "test plan", "what tests do we need" 또는 testing approach, 커버리지, test 아키텍처에 도움이 필요할 때 트리거됩니다.
---
