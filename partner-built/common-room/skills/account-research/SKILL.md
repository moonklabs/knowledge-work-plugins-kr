...
description: Common Room data를 사용해 company를 조사합니다. 'research [company]', 'tell me about [domain]', 'pull up signals for [account]', 'what's going on with [company]' 또는 account-level question에서 트리거됩니다.
---
