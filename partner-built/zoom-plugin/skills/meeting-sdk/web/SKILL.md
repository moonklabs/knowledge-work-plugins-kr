...
description: >-
  Web용 Zoom Meeting SDK입니다. 웹 애플리케이션에 Zoom 미팅 기능을 삽입합니다. Client View와 Component View를 다루며 HD
  video, gallery view, virtual background를 위한 SharedArrayBuffer 설정을 포함합니다.
