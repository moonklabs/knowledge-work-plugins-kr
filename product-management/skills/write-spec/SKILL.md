---
name: write-spec
description: 문제 정의 또는 기능 아이디어에서 기능 명세나 PRD를 작성합니다. 모호한 아이디어/사용자 요청을 구조화된 문서로 바꾸거나, 목표/비목표로 기능 범위를 잡거나, 성공 지표와 인수 기준을 정의하거나, 큰 요청을 단계별 명세로 나눌 때 사용합니다.
argument-hint: "<feature 또는 problem statement>"
---
